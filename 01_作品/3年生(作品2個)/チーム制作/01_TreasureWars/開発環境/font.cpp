...
// デフォルトコンストラクタ
//=====================================
CFont::CFont(int nPriority) : CObject2D(nPriority)
{
...
// 生成処理
//=====================================
CFont* CFont::Create(const D3DXVECTOR3 pos, const D3DXVECTOR3 size, const char* letter, const int priority, const D3DXCOLOR col)
{
	...
	pFont->Setposition(pos);
	pFont->SetSize(size.x, size.y);
