...
void InitLife(void)
{
	...
	D3DXCreateTextureFromFile(
		pDevice,
		"data\\TEXTURE\\life001.png",	//テクスチャのファイル名
		&g_pTextureLife
	);
	//ライフの情報の初期化
	...
	{
		//位置の初期化処理
		g_aLife[nCntLife].pos = D3DXVECTOR3(SCREEN_WIDTH + (LIFE_WIDTH * nCntLife) - (LIFE_WIDTH * MAX_PLAYER_LIFE),
			LIFE_HEIGHT, 0.0f);		//位置
...
void UpdateLife(void)
{
	...
	//ライフが減った分だけfalseにする
	for (nCntLife = pPlayer->nLife; nCntLife < MAX_PLAYER_LIFE; nCntLife++)
	{
